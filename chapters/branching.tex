...
\subsection{State Space Complexity and Branching Factor}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\textwidth}
        ...
        \caption{Possible tile moves after the piece move in Figure \ref{fig:starting piece move to movable} of the tile pointed to}
        \label{fig:starting tile moves after movable}
    \end{minipage}
\end{figure}
After the piece move in Figure \ref{fig:starting piece move to movable}, the total number of possible tile moves, as seen in Figure \ref{fig:starting tile moves after movable}, is $NumOfTiles*D = 6*10=60$. It is identical to the total number of possible tile moves after the piece move in Figure \ref{fig:starting piece move to movable 2}. It is doubled to get the number of possible tile moves for both moves.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.235\textwidth]{pictures/init pos/starting piece move to movable 2.png}
    \caption{The piece move with the same number of tile moves as the one in Figure \ref{fig:starting piece move to movable} }
