...
Legality of a tile move in Nonaga relies solely on the immediate topology of a cell (\cref{sec:tile_movement_legality}). Therefore, the engine only evaluates the six immediate neighbors of a candidate cell. The engine performs a mask to ask a binary question: "Which neighbors are occupied?"
