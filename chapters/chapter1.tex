...
Moreover, the state of the board requires continuous recomputation; between each turn, the legality of moving any specific tile must be dynamically evaluated based on the connectivity of its immediate neighbors.\\
