...
\usepackage{booktabs}
\usepackage{placeins}
% Load hyperref for clickable links
\usepackage[
    pagebackref=true,  % Adds a link back to the citing page in the bibliography
    colorlinks=true,   % Colors the text instead of drawing a box around it
    linkcolor=blue,    % Color for internal document links (sections, figures)
    citecolor=blue,    % Color for bibliography citations
    urlcolor=blue      % Color for external web links
]{hyperref}
% DOI support: must be loaded after hyperref; provides \doi{} command for clickable DOI hyperlinks
\usepackage{doi}
\usepackage[capitalize, noabbrev]{cleveref}

% Optional: Customize how the back-reference text looks in the bibliography
...
\newcommand{\projectTitle}{High-Performance Game AI for Nonaga: A Bitboard Engine with Minimax Search and Genetic Parameter Optimisation}
\newcommand{\fullname}{Karl Samuel Kassis}
\newcommand{\degreeTitle}{BSc in Computer Science}
